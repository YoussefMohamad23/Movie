...
useEffect(()=>{
  ...
  <div className="row bg-dark text-white">
    ...
    {itemDetails.poster_path?<img src={'https://image.tmdb.org/t/p/w500/'+itemDetails.poster_path} className='w-100' alt=""/>:<img src={'https://image.tmdb.org/t/p/w500/'+itemDetails.profile_path} className='w-100' alt=""/>}
        ...
        <div className="col-9" >
          <h2 className=' text-center mt-4'>::: Details :::</h2>
        <h3 className=' h6  my-3'>Name : {itemDetails.title}</h3>
       ...
       <div className="col-md-9">   <p className=' py-2 '>Overview : {itemDetails.overview}</p></div>
